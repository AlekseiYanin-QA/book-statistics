...
public class OAuthController {
    ...
    @Operation(summary = "Получить информацию о вошедшем пользователе или token")
    public Map<String, String> getLoginInfo(@AuthenticationPrincipal OidcUser oidcUser) {
